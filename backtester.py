...
def main():
    ...
    for buy_after_block in range(20, 40):
        for sell_after_block in range(buy_after_block, 300, 5):
    ...
    print(f"Best return: {max_return}, buy_after_block: {best_buy_after_block}, sell_after_block: {best_sell_after_block}")
